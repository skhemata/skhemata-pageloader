...
class SkhemataPageloader extends LitElement {
  constructor() {
    super(...arguments);
    this.title = 'Hey there';
    this.counter = 5;
    this.loadercolor = '#1976d2';

    this.onLoad = () => {
      const loaderElement = this.shadowRoot ? this.shadowRoot.querySelector('.loader-overlay') : null;
  ...
  render() {
    return html`
      <div id="loader-overlay" class="loader-overlay">
        <div class="lds-ring">
          <div
            style="border-color:${this.loadercolor} transparent transparent transparent;"
          ></div>
          <div
            style="border-color:${this.loadercolor} transparent transparent transparent;"
          ></div>
...
__decorate([property({
  type: String
})], SkhemataPageloader.prototype, "title", void 0);

__decorate([property({
  type: Number
})], SkhemataPageloader.prototype, "counter", void 0);

__decorate([property({
  type: String
})], SkhemataPageloader.prototype, "loadercolor", void 0);
